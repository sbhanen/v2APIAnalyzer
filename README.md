...
1. Go to the Premise tab and then open your browser in inspection mode (below is from using Edge).
2. The select the netword tab (1)
3. Then clear all calls that was done so far (2)
4. After the process download the har file (3)
5. 
